...
public static class ScreenTestUtilities
{
    public static Dictionary<ScreenOrientation, Quaternion> OrientationRotation = new Dictionary<ScreenOrientation, Quaternion>
    {
    ...
    public static Dictionary<ScreenOrientation, UIOrientation> ScreenOrientationToUI = new Dictionary<ScreenOrientation, UIOrientation>
    {
    ...
    public static ScreenOrientation[] ExplicitOrientations = { ScreenOrientation.Portrait, ScreenOrientation.PortraitUpsideDown, ScreenOrientation.LandscapeLeft, ScreenOrientation.LandscapeRight };
    ...
    public static void SetPlayerSettingsAutoOrientation(ScreenOrientation orientation, bool value)
    {
        switch (orientation)
        {
            ...
            case ScreenOrientation.LandscapeRight:
                ...
                break;
            default:
                throw new ArgumentException($"Supported values are Portrait, PortraitUpsideDown, LandscapeLeft or LandscapeRight, but {orientation} provided.");
        }
    }
